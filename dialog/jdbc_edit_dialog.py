...
class jdbc_edit_dialog(QtGui.QDialog):
    def __init__(self, parent=None):
        ...
        label = QtGui.QLabel('服务器IP', parent=self)
        ...
        label1 = QtGui.QLabel('用户名', parent=self)
        ...
        label2 = QtGui.QLabel('密码', parent=self)
        ...
        label3 = QtGui.QLabel('端口', parent=self)
        ...
        label4 = QtGui.QLabel('SID', parent=self)
